...
- aaf9d7c: Apply Cloud API changelog entry #450 (Calling integration guidance recommends the new account model for sharing one phone number across providers)
...
- b7314dc: Apply Cloud API changelog entries #447-#449 (service message free tier, max price Open Beta, category review clarification)
...
- 1f581a1: Apply Cloud API changelog entries #444-#446 (October 1, 2026 pricing webhook values, calling rate cards, coexistence onboarding)
...
- d5c618c: Apply Cloud API changelog entry #443 (per-message max price multiplier)
...
- d188fc4: Apply August 2026 Cloud API changelog entries (#424–#426, #430, #433)
...
- bb1cc0e: Apply July 2026 Cloud API changelog entries (#421, #422)
...
- 2c6cc55: Apply June 2026 Cloud API changelog entries (#411–#418)
...
- 1ba0fea: Add missing `PhoneNumber` to `SubTypeEnum`
...
- 27401c8: Fix request/response types to match OpenAPI v23 spec
...
- a408393: Add singleton caching to webhook framework handlers and handler removal methods
