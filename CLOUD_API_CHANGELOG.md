...
- [x] **#410** [Business Management API] Clarified the Business phone numbers documentation: deleting a business phone number isn’t supported via the API. Use WhatsApp Manager⁠ to delete a business phone number.
