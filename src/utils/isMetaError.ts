...
export const WHATSAPP_ERROR_CODES = [
    ...
    131050, 131051, 131052, 131053, 131055, 131056, 131057, 131059, 131061, 131062, 131201, 131202, 131203, 131204,
    131207, 131208, 131209, 131210, 131211, 131212, 131213, 131214, 131215, 132000, 132001, 132005, 132007, 132008,
    132012, 132015, 132016, 132068, 132069, 133000, 133004, 133005, 133006, 133008, 133009, 133010, 133015, 133016,
    134011, 134100, 134101, 134102, 135000, 137000, 138000, 138001, 138002, 138003, 138004, 138005, 138006, 138007,
    138009, 138012, 138013, 138018, 139000, 139001, 139002, 139003, 139004, 139100, 139101, 139102, 139103, 147005,
    200005, 200006, 200007, 1752041, 2388001, 2388012, 2388019, 2388040, 2388047, 2388072, 2388073, 2388091, 2388093,
    2388103, 2388293, 2388299, 2494100, 2593079, 2593085, 2593107, 2593108,
] as const;
...
export const SEND_MESSAGE_ERROR_CODES = [
    ...
    131051, 131052, 131053, 131056, 131057, 131048, 131061, 131062, 132000, 132001, 132005, 132007, 132008, 132012,
    132015, 132016, 132068, 132069, 135000, 137000,
] as const;
