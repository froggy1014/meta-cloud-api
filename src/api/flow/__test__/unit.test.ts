...
import { FlowCategoryEnum, FlowStatusEnum } from '../types';
...
describe('Flow API - Unit Tests', () => {
    ...
    describe('Flow CRUD Operations', () => {
        it('should list flows with correct endpoint', async () => {
            ...
            await whatsApp.flows.listFlows(wabaId);
        ...
        it('should get flow with correct endpoint', async () => {
            ...
            await whatsApp.flows.getFlow(flowId);
        ...
        it('should get flow with fields and date format parameters', async () => {
            ...
            await whatsApp.flows.getFlow(flowId, fields, dateFormat);
        ...
        it('should get flow preview with correct parameters', async () => {
            ...
            await whatsApp.flows.getFlowPreview(flowId, invalidate);
        ...
        it('should delete flow with correct endpoint', async () => {
            ...
            await whatsApp.flows.deleteFlow(flowId);
    ...
    describe('Flow Assets Operations', () => {
        it('should list assets with correct endpoint', async () => {
            ...
            await whatsApp.flows.listAssets(flowId);
        ...
        it('should update flow JSON with Buffer', async () => {
            ...
            await whatsApp.flows.updateFlowJson(flowId, {
                file: jsonBuffer,
        ...
        it('should throw error for invalid file type in updateFlowJson', async () => {
            ...
            await expect(
                whatsApp.flows.updateFlowJson(flowId, {
                    file: invalidFile,
                }),
    ...
    describe('Flow Validation', () => {
        it('should validate flow JSON and return valid response', async () => {
            const mockUpdateFlowJson = vi.spyOn(whatsApp.flows, 'updateFlowJson');
            ...
            const result = await whatsApp.flows.validateFlowJson(flowId, jsonObject);
        ...
        it('should validate flow JSON and return invalid response with errors', async () => {
            ...
            const result = await whatsApp.flows.validateFlowJson(flowId, invalidJson);
    ...
    describe('Flow Lifecycle Operations', () => {
        it('should publish flow with correct endpoint', async () => {
            ...
            await whatsApp.flows.publishFlow(flowId);
        ...
        it('should deprecate flow with correct endpoint', async () => {
            ...
            await whatsApp.flows.deprecateFlow(flowId);
    ...
    describe('Error Handling', () => {
        it('should handle API errors gracefully for list flows', async () => {
            ...
            await expect(whatsApp.flows.listFlows('invalid_waba')).rejects.toThrow('API Error: WABA not found');
        });
        ...
        it('should handle validation errors in validateFlowJson', async () => {
            ...
            await expect(whatsApp.flows.validateFlowJson(flowId, jsonObject)).rejects.toThrow('Network error');
        });
    ...
    describe('API Integration', () => {
        it('should be accessible through WhatsApp instance', () => {
            expect(whatsApp.flows).toBeDefined();
            expect(typeof whatsApp.flows.listFlows).toBe('function');
            expect(typeof whatsApp.flows.createFlow).toBe('function');
            expect(typeof whatsApp.flows.getFlow).toBe('function');
            expect(typeof whatsApp.flows.updateFlowMetadata).toBe('function');
            expect(typeof whatsApp.flows.deleteFlow).toBe('function');
            expect(typeof whatsApp.flows.listAssets).toBe('function');
            expect(typeof whatsApp.flows.updateFlowJson).toBe('function');
            expect(typeof whatsApp.flows.validateFlowJson).toBe('function');
            expect(typeof whatsApp.flows.publishFlow).toBe('function');
            expect(typeof whatsApp.flows.deprecateFlow).toBe('function');
            expect(typeof whatsApp.flows.migrateFlows).toBe('function');
        });
