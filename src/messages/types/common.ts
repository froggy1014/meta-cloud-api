...
export declare class MessagesClass extends BaseClass {
    ...
    template(
        params: MessageRequestParams<
            import('./template').MessageTemplateObject<import('../../types/enums').ComponentTypesEnum>
        >,
    ...
    interactiveList(
        params: MessageRequestParams<
            import('./interactive').InteractiveObject & { type: import('../../types/enums').InteractiveTypesEnum.List }
        >,
    ): Promise<MessagesResponse>;
    interactiveCtaUrl(
        params: MessageRequestParams<
            import('./interactive').InteractiveObject & {
                type: import('../../types/enums').InteractiveTypesEnum.CtaUrl;
            }
        >,
    ): Promise<MessagesResponse>;
    interactiveLocationRequest(
        params: MessageRequestParams<
            import('./interactive').InteractiveObject & {
                type: import('../../types/enums').InteractiveTypesEnum.LocationRequest;
            }
        >,
    ): Promise<MessagesResponse>;
    interactiveAddressMessage(
        params: MessageRequestParams<
            import('./interactive').InteractiveObject & {
                type: import('../../types/enums').InteractiveTypesEnum.AddressMessage;
            }
        >,
    ): Promise<MessagesResponse>;
    interactiveReplyButtons(
        params: MessageRequestParams<
            import('./interactive').InteractiveObject & {
                type: import('../../types/enums').InteractiveTypesEnum.Button;
            }
        >,
    ): Promise<MessagesResponse>;
    interactiveFlow(
        params: MessageRequestParams<
            import('./interactive').InteractiveObject & { type: import('../../types/enums').InteractiveTypesEnum.Flow }
        >,
    ): Promise<MessagesResponse>;
