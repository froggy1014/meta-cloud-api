...
const config = {
    ...
    phoneNumberId: process.env.WHATSAPP_PHONE_NUMBER_ID ? Number(process.env.WHATSAPP_PHONE_NUMBER_ID) : undefined,
    businessAcctId: process.env.WHATSAPP_BUSINESS_ACCOUNT_ID || '',
    webhookVerificationToken: process.env.WEBHOOK_VERIFICATION_TOKEN || 'your_verification_token',
};
