...
function CardHeader({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn(
                'tw:@container/card-header has-data-[slot=card-action]:tw:grid-cols-[1fr_auto] [.border-b]:tw:pb-6 tw:grid tw:auto-rows-min tw:grid-rows-[auto_auto] tw:items-start tw:gap-1.5 tw:px-6',
                className,
            )}
            {...props}
        />
...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
    return <div data-slot="card-title" className={cn('tw:font-semibold tw:leading-none', className)} {...props} />;
}
...
function CardFooter({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn('[.border-t]:tw:pt-6 tw:flex tw:items-center tw:px-6', className)}
            {...props}
        />
    );
}
