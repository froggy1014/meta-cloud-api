import { ContactMessageBuilder, type WebhookMessage, type WhatsApp } from 'meta-cloud-api';

/**
 * Handler for contact messages
 * Responds with a sample contact card using builder pattern
 */
export const handleContactMessage = async (whatsapp: WhatsApp, message: WebhookMessage) => {
    ...
    // Build and send contact response
